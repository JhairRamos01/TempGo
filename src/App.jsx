...
export default function App() {
  ...
  const back = () => setScreen(({ dashboard: 'setup', setup: 'food', food: 'login' })[screen] || 'login');
  ...
  return <div className={`app ${theme}`}>
    ...
    <main className="container">
      {screen === 'login' && <section className="landing">
        ...
        <Card className="form-card"><h2>1. Acceder / Login</h2><form onSubmit={e => { e.preventDefault(); setScreen('food'); }}>
          ...
          <Button type="submit" label="INGRESAR" className="full" /></form></Card>
      </section>}

      {screen === 'food' && <Card className="form-card narrow"><h2>2. Ingreso del alimento</h2>
